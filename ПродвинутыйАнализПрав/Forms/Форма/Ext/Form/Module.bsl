...
// Обработчик завершения выбора роли
//
&НаКлиенте
Процедура ИмяРолиВыборЗавершение(ВыбранныеОбъекты, ДополнительныеПараметры) Экспорт
	...
	ПолноеИмя = ВыбранныеОбъекты[0].Значение;
...
// Открывает форму выбора объектов метаданных с фильтром по типам
//
&НаКлиенте
...
// Обработчик завершения выбора объекта метаданных
//
&НаКлиенте
Процедура ОбъектМетаданныхВыборЗавершение(ВыбранныеОбъекты, ДополнительныеПараметры) Экспорт
	...
	ОбъектМетаданных = ВыбранныеОбъекты[0].Значение;
